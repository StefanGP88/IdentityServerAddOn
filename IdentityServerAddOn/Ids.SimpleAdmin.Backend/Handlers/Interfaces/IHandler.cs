...
namespace Ids.SimpleAdmin.Backend.Handlers.Interfaces
{
    public interface IHandler<TData, TIdentifier>
    {
        ...
        Task<TData> Get(TIdentifier id, int page, int pageSize, CancellationToken cancel);
        ...
        Task<TData> Update(TData dto, int page, int pageSize, CancellationToken cancel);
    }
}
